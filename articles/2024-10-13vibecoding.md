...
前回の掲示板アプリを改良する際、元のプログラム（mainブランチ）を直接変更せず、デザインや機能ごとにブランチを切って開発できるようにしたい。
Codex CLIに自然言語で指示して、この一連のブランチ運用を完結させられるようにしてみましょう！
...
- レビュアーと差分を見ながら最終調整（気になる点は修正して再プッシュ）
